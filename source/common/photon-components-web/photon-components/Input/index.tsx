...
export class Input extends React.Component<InputProps, InputState> {
		...
		return (
			<label {...{ style, className: classNameWithMods('input') }}>
				...
				<input
					...
					{...{ type, value, ...props }}
				/>
				{hasContent && !isPassword && !this.props.disabled && this.renderClearButton()}
	...
	renderClearButton = () => <span className="input__clear" onClick={this.handleClear}></span>;
	...
	renderPasswordVisibilityButton = () => (
		<span className="input__passwordVisibility" onClick={this.togglePasswordVisibility}>
